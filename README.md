# PyB4ML
PyB4ML is a free open-source collection of algorithms in Bayesian machine learning written in Python for probabilistic programming and reasoning by using Bayesian and Markov networks.
