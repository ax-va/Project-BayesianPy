...
class SumProduct(Factored):
    ...
    def _create_factor_to_variable_message_from_leaf(self, from_factor, to_variable):
        if (from_factor, to_variable) not in self._factor_to_variable_messages.keys():
            # Compute the message
    ...
    def _create_variable_to_factor_message_not_from_leaf(self, from_variable, to_factor):
        # from_variable was previously to_variable
        to_variable = from_variable
        if (from_variable, to_factor) not in self._variable_to_factor_messages.keys():
    ...
    def _propagate_factor_to_variable_message_from_leaf(self, from_factor):
        # The leaf factor has only one variable
        to_variable = from_factor.variables[0]
        self._create_factor_to_variable_message_from_leaf(from_factor, to_variable)
    ...
    def _propagate_factor_to_variable_messages_from_leaves(self):
        for from_factor in self.factor_leaves:
            self._propagate_factor_to_variable_message_from_leaf(from_factor)

    def _propagate_variable_to_factor_message_from_leaf(self, from_variable):
    ...
    def _propagate_variable_to_factor_messages_from_leaves(self):
        for from_variable in self.variable_leaves:
            if from_variable is self._query_variable:
                continue
            self._propagate_variable_to_factor_message_from_leaf(from_variable)
    ...
    def _propagate_variable_to_factor_message_not_from_leaf(self, from_variable):
        ...
        self._create_variable_to_factor_message_not_from_leaf(from_variable, to_factor)
