...
class SumProduct(InferenceAlgorithm):
    ...
    leaves along the tree to the query-variable.  That can be considered as the successive 
    ...
    lock on loopy graphs.  The factors must have strictly positive values because of the
    use of logarithms of them.
