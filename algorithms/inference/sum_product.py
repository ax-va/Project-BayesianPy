...
class SumProduct(InferenceAlgorithm):
    ...
    the factors and variables in the factor graph.  Instead of the messages, the 
    implementation uses logarithms of them for computational stability.  See, for example, 
    "Bayesian Reasoning and Machine Learning" by David Barber, 2012, for more details.
    ...
    lock on loopy graphs.  The factors must be strongly positive because of using 
    logarithms of them.
