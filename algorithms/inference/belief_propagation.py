...
class BPA(FactoredAlgorithm):
    ...
    categorical probability distributions.  That algorithm belongs to Message Passing and 
    Variable Elimination Algorithms.  There, the factor-to-variable and variable-to-factor
