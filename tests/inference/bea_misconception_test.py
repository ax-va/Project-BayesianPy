...
assert 0.9979707927214664 - eps <= pd('a0', 'b0') <= 0.9979707927214664 + eps
assert 0.0016632846545357773 - eps <= pd('a0', 'b1') <= 0.0016632846545357773 + eps
assert 0.0003326569309071555 - eps <= pd('a1', 'b0') <= 0.0003326569309071555 + eps
assert 3.3265693090715545e-05 - eps <= pd('a1', 'b1') <= 3.3265693090715545e-05 + eps
